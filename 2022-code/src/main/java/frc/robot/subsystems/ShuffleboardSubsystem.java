  ...
  public void debugTab() {
    ...
    m_shooterRPMGraph =
        m_debugTab
            ...
            .getEntry();
    m_shooterPID[0] =
        m_debugTab.add("Shooter P", m_shooter.getP()).withPosition(0, 2).withSize(1, 1).getEntry();
    m_shooterPID[1] =
        m_debugTab.add("Shooter I", m_shooter.getI()).withPosition(0, 3).withSize(1, 1).getEntry();
    m_shooterPID[2] =
        m_debugTab.add("Shooter D", m_shooter.getD()).withPosition(0, 4).withSize(1, 1).getEntry();

    m_driveVariables[0] =
        m_debugTab.add("DriveRMotor1", 0).withPosition(2, 2).withSize(1, 1).getEntry();
    m_driveVariables[1] =
        m_debugTab.add("DriveRMotor2", 0).withPosition(3, 2).withSize(1, 1).getEntry();
    m_driveVariables[2] =
    ...
    m_climberVariables[1] =
        m_debugTab.add("Climber 2", 0).withPosition(6, 3).withSize(1, 1).getEntry();
    m_climberVariables[2] =
        m_debugTab.add("Climber Switch", 0).withPosition(8, 3).withSize(1, 1).getEntry();
    ...
    m_turretPositionGraph =
        m_debugTab
            ...
            .getEntry();
    m_turretPID[0] =
        m_debugTab.add("Turret P", m_turret.getP()).withPosition(1, 2).withSize(1, 1).getEntry();
    m_turretPID[1] =
        m_debugTab.add("Turret I", m_turret.getI()).withPosition(1, 3).withSize(1, 1).getEntry();
    m_turretPID[2] =
        m_debugTab.add("Turret D", m_turret.getD()).withPosition(1, 4).withSize(1, 1).getEntry();

    m_indexVariables[0] =
        m_debugTab.add("Index Motor 2", 0).withPosition(6, 3).withSize(1, 1).getEntry();
    m_indexVariables[1] =
        m_debugTab.add("Index Beambreak", 0).withPosition(4, 3).withSize(1, 1).getEntry();

    m_limelightVariables[0] =
        m_debugTab.add("Limelight Tx", 0).withPosition(4, 4).withSize(1, 1).getEntry();
    m_limelightVariables[1] =
        m_debugTab.add("Limelight Ty", 0).withPosition(6, 4).withSize(1, 1).getEntry();
    m_limelightVariables[2] =
        m_debugTab.add("Limelight Ta", 0).withPosition(8, 4).withSize(1, 1).getEntry();
    m_limelightVariables[3] =
        m_debugTab.add("Limelight Tv", 0).withPosition(10, 4).withSize(1, 1).getEntry();
    m_limelightVariables[4] =
        m_debugTab.add("Limelight Distance", 0).withPosition(11, 4).withSize(1, 1).getEntry();
  }
}
