...
public class DrivestationBoard extends SubsystemBase
{
    ...
    public DrivestationBoard()
    {
        ...
        m_test_joystickPosition = m_drivestationTab.add("Joystick position", 2).withPosition(0, 0).withSize(2,
            2).getEntry();
        m_user = m_drivestationTab.add("Username", "neutrino").withPosition(2, 0).withSize(2, 2).getEntry();
    }
