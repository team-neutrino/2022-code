...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    m_start.whenHeld(new SequentialCommandGroup(new ClimbKeyUnlockCommand(m_climber), new WaitCommand(0.5), new ClimbUPCommand(m_climber)));
    m_back.whenHeld(new SequentialCommandGroup(new ClimbKeyUnlockCommand(m_climber),new WaitCommand(0.5), new ClimbDOWNCommand(m_climber), new ClimbKeylockCommand(m_climber)));
