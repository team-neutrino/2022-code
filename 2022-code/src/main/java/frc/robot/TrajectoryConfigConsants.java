...
public class TrajectoryConfigConsants
{
    ...
    public static final DifferentialDriveKinematics K_DRIVE_KINEMATICS = new DifferentialDriveKinematics(0);
    ...
    new TrajectoryConfig(
        K_HALF_SPEED_METERS_PER_SECOND,
        K_MAX_ACCELERATION_METERS_PER_SECOND_SQUARED).setKinematics(K_DRIVE_KINEMATICS)
